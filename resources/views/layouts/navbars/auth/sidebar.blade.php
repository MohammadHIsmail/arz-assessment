...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-2 fixed-start"
    id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">Bloodbath and Beyond</span>
        </a>
    </div>
    <hr class="horizontal dark mt-0 w-75 ml-2">
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        ...
        @can('department-list')
            <li class="nav-item pb-2">
                <a class="nav-link {{ Route::currentRouteName() == 'departments' ? 'active' : '' }}"
